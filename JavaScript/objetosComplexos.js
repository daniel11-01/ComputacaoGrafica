...
export function criarAneis() {
    ...
    var pos = [
        // Plataforma 1 — arco antes dos picos (z=32) + 1 depois
        [-1.5,1.5,37],[0,2.0,37],[1.5,1.5,37],
        [0,1.5,22],

        // Ponte 1
        [0,1.5,12],[0,1.5,9],

        // Plataforma 2 — entre os dois grupos de picos (z=-4 e z=-14) e depois
        [0,1.5,-8],
        [0,1.5,-19],

        // Entrada do loop (fora da estrutura)
        [-1.5,1.5,-21],[0,2.0,-21],[1.5,1.5,-21],

        // Plataforma 3 — saída do loop + antes dos picos (z=-50)
        [0,1.5,-37],[0,1.5,-39],[0,1.5,-44],
        [0,1.5,-55],
        ...
        // Plataforma 4
        [-1.5,1.5,-65],[0,2.0,-65],[1.5,1.5,-65],
        [0,1.5,-73],[0,1.5,-80],
    ];
